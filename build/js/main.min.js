...
exports.updateAdvantagesSlides = void 0;
var updateAdvantagesSlides = function updateAdvantagesSlides() {
  var wrapper = document.querySelector('.advantages__swiper-wrapper');
  var slides = wrapper.querySelectorAll('.advantage-card');
...
exports.updateAdvantagesSlides = updateAdvantagesSlides;
...
exports.attachAudioPlayer = void 0;
var attachAudioPlayer = function attachAudioPlayer() {
  var audioPlayerContainer = document.querySelector('.hero__swiper');
  if (audioPlayerContainer) {
    audioPlayerContainer.addEventListener('click', function (event) {
      var clickedButton = event.target.closest('.audio-player__play-button');
      if (clickedButton) {
        var audioPlayer = clickedButton.closest('.audio-player');
        if (audioPlayer) {
...
exports.attachVideoPlayer = void 0;
var attachVideoPlayer = function attachVideoPlayer() {
  var heroSwiperContainer = document.querySelector('.hero__swiper');
  if (heroSwiperContainer) {
    heroSwiperContainer.addEventListener('click', function (event) {
      var clickedPlayButton = event.target.closest('.play-button');
      if (clickedPlayButton) {
        var heroVideo = clickedPlayButton.closest('.hero__video');
        if (heroVideo) {
          var iframe = document.createElement('iframe');
...
exports.attachVideoPlayer = attachVideoPlayer;
...
var _iframeVideo = require("./iframe-video");
var _iframeAudio = require("./iframe-audio");
var _advantageCardChecker = require("./advantage-card-checker");
// ---------------------------------

window.addEventListener('DOMContentLoaded', function () {
  (0, _mobileMenu.attachMobileMenu)();
  (0, _iframeVideo.attachVideoPlayer)();
  (0, _iframeAudio.attachAudioPlayer)();
  (0, _advantageCardChecker.updateAdvantagesSlides)();
...
},{"./advantage-card-checker":1,"./iframe-audio":2,"./iframe-video":3,"./mobile-menu":5,"./modules/form-validate/form":7,"./modules/modals/init-modals":13,"./utils/ios-vh-fix":17}],5:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.attachMobileMenu = void 0;
var attachMobileMenu = function attachMobileMenu() {
  ...
  var menuToggleIconMenu = document.querySelector('.main-header__icon-menu');
  var menuToggleIconCross = document.querySelector('.main-header__icon-cross');
  var menuItems = document.querySelectorAll('.main-navigation__link');
  var mainHeaderPhone = document.querySelector('.main-header__phone');
...
exports.attachMobileMenu = attachMobileMenu;
